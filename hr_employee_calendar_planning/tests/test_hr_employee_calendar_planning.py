...
class TestHrEmployeeCalendarPlanning(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.future_global_leave = cls.env["resource.calendar.leaves"].create(
            {
                "name": "Future Global Leave",
                "date_from": "2040-03-09",
                "date_to": "2040-03-10",
            }
        )
        ...
        cls.calendar2.global_leave_ids = [
            (6, 0, [cls.global_leave3.id, cls.future_global_leave.id])
        ]
    ...
    def test_copy_global_leaves(self):
        ...
        # only future global leaves should be copied
        self.assertEqual(
            {
                global_leave.name
